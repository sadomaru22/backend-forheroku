...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        //         return (new MailMessage)
        //             ->subject(Lang::get('Reset Password Notification'))
        //             ->greeting(Lang::get('You are receiving this email because we received a password reset request for your account.'))
        //             ->line(Lang::get('Please click the button below for a password reset.'))
        //             ->action(Lang::get('Reset Password'), $url)
